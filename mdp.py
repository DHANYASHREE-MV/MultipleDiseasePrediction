...
# Hide Streamlit branding, hamburger, and adjust sidebar spacing
st.markdown("""
    <style>
        /* Hides the default Streamlit multipage navigation */
...
# Load your models
diabetes_model = pickle.load(open('C:/Users/Radha/OneDrive/Desktop/Multiple Disease prediction system/saved models/diabetes_model.sav', 'rb'))
heart_disease_model = pickle.load(open('C:/Users/Radha/OneDrive/Desktop/Multiple Disease prediction system/saved models/heart_disease_model.sav', 'rb'))
parkinsons_model = pickle.load(open('C:/Users/Radha/OneDrive/Desktop/Multiple Disease prediction system/saved models/parkinsons_model.sav', 'rb'))
...
lottie_medical = load_lottieurl("https://assets1.lottiefiles.com/packages/lf20_tutvdkg0.json")
...
with st.sidebar:
    selected = option_menu(
        ...
        icons=['activity', 'heart-pulse', 'person-raised-hand'],
        default_index=0
    )
...
<br>© 2025 Disease Prediction System
""", unsafe_allow_html=True)
